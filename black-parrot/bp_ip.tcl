...
set_property value -1 [ipx::get_bus_parameters FREQ_TOLERANCE_HZ -of_objects [ipx::get_bus_interfaces m01_axi_aclk -of_objects [ipx::current_core]]]ipx::add_bus_parameter FREQ_TOLERANCE_HZ [ipx::get_bus_interfaces s00_axi_aclk -of_objects [ipx::current_core]]
